...
function ShowEvent() {
    ...
    return ( <
        ...
        { " " } { /* <!-- slider Area Start--> */ } { /* <!-- slider Area End--> */ } { " " } { /* <!-- Favourite Places Start/ --> */ } { " " } <
        ...
        <
        span style = {
            { color: "#A32626", marginTop: "2rem" } } > HAVE A GOOD DAY < /span> <
        h2 > Our Events < /h2>{" "} <
        /div>{" "} <
        /div>{" "} <
        /div>{" "} <
        div class = "row" > { " " } {
            eventList.map((event, key) => {
                return ( <
                    ...
                    div class = "place-img" >
                    <
                    img src = { `https://api.preciouscollege.edu.np${event.image}` }
                    alt = "" /
                    >
                    <
                    /div>{" "} <
